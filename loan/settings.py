...
DATABASES = {
    "default": db_config(default=config("DATABASE_URL", default="sqlite:///db.sqlite3"))
}
...
TINYMCE_DEFAULT_CONFIG = {
    ...
    "selector": "textarea",
    "plugins": """
        save link preview codesample table code lists fullscreen insertdatetime nonbreaking
        directionality searchreplace wordcount visualblocks
        visualchars code fullscreen autolink charmap
        anchor pagebreak 
        """,
    "toolbar1": """
